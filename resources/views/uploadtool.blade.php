...
<div class="container d-flex justify-content-center mt-5">
    <div class="card shadow-sm p-4" style="max-width: 600px; width: 100%;">
        ...
        <form id="uploadForm" class="needs-validation" novalidate enctype="multipart/form-data">
            ...
            <!-- BIM File -->
            <div class="mb-3">
                <label for="bimfile" class="form-label">
                    BIM File (.bim / .sqlite / .sqlite3 / .db) <span class="text-danger">*</span>
                </label>
                <input class="form-control"
                       type="file"
                       id="bimfile"
                       name="bimfile"
                       accept=".bim,.sqlite,.sqlite3,.db"
                       required>
                <div class="invalid-feedback">Please select a valid BIM file.</div>
            </div>

            <!-- RAW File -->
            <div class="mb-3">
                <label for="rawfile" class="form-label">
                    RAW File (.xlsx / .xls / .csv) <span class="text-danger">*</span>
                </label>
                <input class="form-control"
                       type="file"
                       id="rawfile"
            ...
            <!-- Mapping Source -->
            <div class="mb-3">
                <label for="data_source" class="form-label">Mapping Type</label>
...
<!-- Mapping Section -->
<div class="container mt-5" id="mapping-section" style="display:block;">
    <h4 class="text-center mb-3">Database/Excel Columns Mapping</h4>
...
$(document).ready(function() {
    ...
    $('#executeBtn').on('click', function() {
        alert('Executing data update... (you can add your logic here)');
    });
